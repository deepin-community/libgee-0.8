/* testsortedmap.c generated by valac 0.52.0, the Vala compiler
...
GeeSortedMapTestsSubMapTests* gee_sorted_map_tests_sub_map_tests_new (GeeSortedMapTests* test,
                                                                      GeeSortedMapTestsSubMapTestsType type);
GeeSortedMapTestsSubMapTests* gee_sorted_map_tests_sub_map_tests_construct (GType object_type,
                                                                            GeeSortedMapTests* test,
                                                                            GeeSortedMapTestsSubMapTestsType type);
...
void gee_sorted_map_tests_sub_map_tests_set_default_values (GeeSortedMapTestsSubMapTests* self,
                                                            gchar*** contains,
	...
	_tmp29__length1 = success_length1;
	{
		...
		for (s_it = 0; s_it < s_collection_length1; s_it = s_it + 1) {
			...
			s = _tmp30_;
			{
				...
				_tmp35_ = s;
				_tmp36_ = s;
				_vala_assert (gee_map_has ((GeeMap*) _tmp34_, _tmp35_, _tmp36_), "submap.has (s, s)");
				_tmp37_ = self->priv->master;
				_tmp38_ = s;
				_tmp39_ = s;
				_vala_assert (gee_map_has ((GeeMap*) _tmp37_, _tmp38_, _tmp39_), "master.has (s, s)");
				_g_free0 (s);
			}
		}
	}
	_tmp40_ = fail;
	_tmp40__length1 = fail_length1;
	{
		gchar** s_collection = NULL;
		gint s_collection_length1 = 0;
		gint _s_collection_size_ = 0;
		...
		for (s_it = 0; s_it < s_collection_length1; s_it = s_it + 1) {
			...
			s = _tmp41_;
			{
				...
				const gchar* _tmp48_;
				_tmp42_ = self->priv->submap;
				_tmp43_ = s;
				_tmp44_ = s;
				gee_map_set ((GeeMap*) _tmp42_, _tmp43_, _tmp44_);
				_tmp45_ = self->priv->submap;
				_tmp46_ = s;
				_vala_assert (!gee_map_has_key ((GeeMap*) _tmp45_, _tmp46_), "!submap.has_key (s)");
				_tmp47_ = self->priv->master;
				_tmp48_ = s;
				_vala_assert (!gee_map_has_key ((GeeMap*) _tmp47_, _tmp48_), "!master.has_key (s)");
				_g_free0 (s);
			}
		}
	}
	_tmp49_ = self->priv->master;
	_tmp50_ = gee_map_get_size ((GeeMap*) _tmp49_);
	_tmp51_ = _tmp50_;
	_tmp52_ = success;
...
gee_sorted_map_tests_sub_map_tests_test_iterators (GeeSortedMapTestsSubMapTests* self)
{
	...
	gchar** _tmp52_;
	gint _tmp52__length1;
	GeeSortedMapTestsSubMapTestsType _tmp53_;
	g_return_if_fail (self != NULL);
	_tmp0_ = self->priv->submap;
	...
	_tmp53_ = self->priv->type;
	if (_tmp53_ != GEE_SORTED_MAP_TESTS_SUB_MAP_TESTS_TYPE_EMPTY) {
		GeeMapIterator* map_iter = NULL;
		GeeSortedMap* _tmp54_;
		...
		_tmp54_ = self->priv->submap;
		_tmp55_ = gee_map_map_iterator ((GeeMap*) _tmp54_);
		map_iter = _tmp55_;
		_tmp56_ = map_iter;
		_vala_assert (gee_map_iterator_next (_tmp56_), "map_iter.next ()");
		_tmp57_ = map_iter;
		_tmp58_ = gee_map_iterator_get_key (_tmp57_);
		_tmp59_ = (gchar*) _tmp58_;
		_tmp60_ = contains;
		_tmp60__length1 = contains_length1;
		_tmp61_ = _tmp60_[0];
		_vala_assert (g_strcmp0 (_tmp59_, _tmp61_) == 0, "map_iter.get_key () == contains[0]");
		_g_free0 (_tmp59_);
		_tmp62_ = map_iter;
		_tmp63_ = gee_map_iterator_get_value (_tmp62_);
		_tmp64_ = (gchar*) _tmp63_;
		_tmp65_ = contains;
		_tmp65__length1 = contains_length1;
		_tmp66_ = _tmp65_[0];
		_vala_assert (g_strcmp0 (_tmp64_, _tmp66_) == 0, "map_iter.get_value () == contains[0]");
		_g_free0 (_tmp64_);
		_tmp67_ = map_iter;
		_vala_assert (gee_map_iterator_has_next (_tmp67_), "map_iter.has_next ()");
		_tmp68_ = map_iter;
		_vala_assert (gee_map_iterator_next (_tmp68_), "map_iter.next ()");
		_tmp69_ = map_iter;
		_tmp70_ = gee_map_iterator_get_key (_tmp69_);
		_tmp71_ = (gchar*) _tmp70_;
		_tmp72_ = contains;
		_tmp72__length1 = contains_length1;
		_tmp73_ = _tmp72_[1];
		_vala_assert (g_strcmp0 (_tmp71_, _tmp73_) == 0, "map_iter.get_key () == contains[1]");
		_g_free0 (_tmp71_);
		_tmp74_ = map_iter;
		_tmp75_ = gee_map_iterator_get_value (_tmp74_);
		_tmp76_ = (gchar*) _tmp75_;
		_tmp77_ = contains;
		_tmp77__length1 = contains_length1;
		_tmp78_ = _tmp77_[1];
		_vala_assert (g_strcmp0 (_tmp76_, _tmp78_) == 0, "map_iter.get_value () == contains[1]");
		_g_free0 (_tmp76_);
		_tmp79_ = self->priv->master;
		gee_map_clear ((GeeMap*) _tmp79_);
		gee_sorted_map_tests_sub_map_tests_set_default_values (self, &_tmp80_, &_tmp81_, &_tmp82_, &_tmp83_);
		contains = (_vala_array_free (contains, contains_length1, (GDestroyNotify) g_free), NULL);
		contains = _tmp80_;
		contains_length1 = _tmp81_;
		_contains_size_ = contains_length1;
		not_contains = (_vala_array_free (not_contains, not_contains_length1, (GDestroyNotify) g_free), NULL);
		not_contains = _tmp82_;
		not_contains_length1 = _tmp83_;
		_not_contains_size_ = not_contains_length1;
		_tmp84_ = self->priv->submap;
		_tmp85_ = gee_sorted_map_get_ascending_keys (_tmp84_);
		_tmp86_ = _tmp85_;
		_tmp87_ = _tmp86_;
		...
		keys_iter = _tmp89_;
		_tmp90_ = keys_iter;
		_vala_assert (gee_iterator_has_next (_tmp90_), "keys_iter.has_next ()");
		_tmp91_ = keys_iter;
		_vala_assert (gee_iterator_next (_tmp91_), "keys_iter.next ()");
		_tmp92_ = keys_iter;
		...
		_tmp96_ = _tmp95_[0];
		_vala_assert (g_strcmp0 (_tmp94_, _tmp96_) == 0, "keys_iter.get () == contains[0]");
		_g_free0 (_tmp94_);
		_tmp97_ = keys_iter;
		_vala_assert (gee_iterator_has_next (_tmp97_), "keys_iter.has_next ()");
		_tmp98_ = keys_iter;
		_vala_assert (gee_iterator_next (_tmp98_), "keys_iter.next ()");
		_tmp99_ = keys_iter;
		_tmp100_ = gee_iterator_get (_tmp99_);
		_tmp101_ = (gchar*) _tmp100_;
		_tmp102_ = contains;
		_tmp102__length1 = contains_length1;
		_tmp103_ = _tmp102_[1];
		_vala_assert (g_strcmp0 (_tmp101_, _tmp103_) == 0, "keys_iter.get () == contains[1]");
		_g_free0 (_tmp101_);
		_tmp104_ = self->priv->master;
		gee_map_clear ((GeeMap*) _tmp104_);
		gee_sorted_map_tests_sub_map_tests_set_default_values (self, &_tmp105_, &_tmp106_, &_tmp107_, &_tmp108_);
		contains = (_vala_array_free (contains, contains_length1, (GDestroyNotify) g_free), NULL);
		contains = _tmp105_;
		contains_length1 = _tmp106_;
		_contains_size_ = contains_length1;
		not_contains = (_vala_array_free (not_contains, not_contains_length1, (GDestroyNotify) g_free), NULL);
		not_contains = _tmp107_;
		not_contains_length1 = _tmp108_;
		_not_contains_size_ = not_contains_length1;
		_tmp109_ = self->priv->submap;
		_tmp110_ = gee_sorted_map_get_ascending_entries (_tmp109_);
		_tmp111_ = _tmp110_;
		_tmp112_ = _tmp111_;
		_tmp113_ = gee_iterable_iterator ((GeeIterable*) _tmp112_);
		_tmp114_ = _tmp113_;
		_g_object_unref0 (_tmp112_);
		entries_iter = _tmp114_;
		_tmp115_ = entries_iter;
		_vala_assert (gee_iterator_has_next (_tmp115_), "entries_iter.has_next ()");
		_tmp116_ = entries_iter;
		_vala_assert (gee_iterator_next (_tmp116_), "entries_iter.next ()");
		_tmp117_ = entries_iter;
		_tmp118_ = gee_iterator_get (_tmp117_);
		_tmp119_ = (GeeMapEntry*) _tmp118_;
		_tmp120_ = contains;
		_tmp120__length1 = contains_length1;
		_tmp121_ = _tmp120_[0];
		_tmp122_ = contains;
		_tmp122__length1 = contains_length1;
		_tmp123_ = _tmp122_[0];
		map_tests_assert_entry (_tmp119_, _tmp121_, _tmp123_);
		_g_object_unref0 (_tmp119_);
		_tmp124_ = entries_iter;
		_vala_assert (gee_iterator_has_next (_tmp124_), "entries_iter.has_next ()");
		_tmp125_ = entries_iter;
		_vala_assert (gee_iterator_next (_tmp125_), "entries_iter.next ()");
		_tmp126_ = entries_iter;
		_tmp127_ = gee_iterator_get (_tmp126_);
		_tmp128_ = (GeeMapEntry*) _tmp127_;
		_tmp129_ = contains;
		_tmp129__length1 = contains_length1;
		_tmp130_ = _tmp129_[1];
		_tmp131_ = contains;
		_tmp131__length1 = contains_length1;
		_tmp132_ = _tmp131_[1];
		map_tests_assert_entry (_tmp128_, _tmp130_, _tmp132_);
		...
		GeeIterator* keys_iter = NULL;
		GeeSortedMap* _tmp133_;
		GeeSortedSet* _tmp134_;
		GeeSortedSet* _tmp135_;
		GeeSortedSet* _tmp136_;
		GeeIterator* _tmp137_;
		GeeIterator* _tmp138_;
		_tmp133_ = self->priv->submap;
		_tmp134_ = gee_sorted_map_get_ascending_keys (_tmp133_);
		_tmp135_ = _tmp134_;
		_tmp136_ = _tmp135_;
	...
	switch (_tmp10_) {
		...
		case GEE_SORTED_MAP_TESTS_SUB_MAP_TESTS_TYPE_EMPTY:
		{
			...
			if (g_test_trap_fork ((guint64) 0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR)) {
				...
				gchar* _tmp52_;
				_tmp50_ = keys;
				_tmp51_ = gee_sorted_set_last (_tmp50_);
			...
			if (g_test_trap_fork ((guint64) 0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR)) {
				...
				GeeMapEntry* _tmp55_;
				_tmp53_ = entries;
				_tmp54_ = gee_sorted_set_first (_tmp53_);
				_tmp55_ = (GeeMapEntry*) _tmp54_;
				_g_object_unref0 (_tmp55_);
				exit (0);
			}
			...
			if (g_test_trap_fork ((guint64) 0, G_TEST_TRAP_SILENCE_STDOUT | G_TEST_TRAP_SILENCE_STDERR)) {
				...
				GeeMapEntry* _tmp58_;
				_tmp56_ = entries;
				_tmp57_ = gee_sorted_set_last (_tmp56_);
