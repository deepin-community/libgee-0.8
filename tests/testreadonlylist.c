/* testreadonlylist.c generated by valac 0.52.0, the Vala compiler
...
GeeCollection* read_only_collection_tests_get_ro_view (ReadOnlyCollectionTests* self,
...
ReadOnlyListTests* read_only_list_tests_construct_with_name (GType object_type,
                                                             const gchar* name);
ReadOnlyCollectionTests* read_only_collection_tests_new_with_name (const gchar* name);
ReadOnlyCollectionTests* read_only_collection_tests_construct_with_name (GType object_type,
                                                                         const gchar* name);
