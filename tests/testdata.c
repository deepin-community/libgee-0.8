/* testdata.c generated by valac 0.52.0, the Vala compiler
...
GParamSpec* param_spec_test_data (const gchar* name,
                                  const gchar* nick,
                                  const gchar* blurb,
                                  GType object_type,
                                  GParamFlags flags);
void value_set_test_data (GValue* value,
                          gpointer v_object);
void value_take_test_data (GValue* value,
                           gpointer v_object);
...
gchar** test_data_get_sorted_data (gint* result_length1);
