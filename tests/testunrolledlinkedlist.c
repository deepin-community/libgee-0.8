/* testunrolledlinkedlist.c generated by valac 0.52.0, the Vala compiler
...
GType unrolled_linked_list_tests_get_type (void) G_GNUC_CONST ;
...
UnrolledLinkedListTests* unrolled_linked_list_tests_new (void);
UnrolledLinkedListTests* unrolled_linked_list_tests_construct (GType object_type);
BidirListTests* bidir_list_tests_construct (GType object_type,
                                            const gchar* name);
...
{
	static volatile gsize unrolled_linked_list_tests_type_id__volatile = 0;
	if (g_once_init_enter (&unrolled_linked_list_tests_type_id__volatile)) {
		GType unrolled_linked_list_tests_type_id;
		unrolled_linked_list_tests_type_id = unrolled_linked_list_tests_get_type_once ();
		g_once_init_leave (&unrolled_linked_list_tests_type_id__volatile, unrolled_linked_list_tests_type_id);
	}
	return unrolled_linked_list_tests_type_id__volatile;
}
