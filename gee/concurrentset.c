/* concurrentset.c generated by valac 0.52.0, the Vala compiler
...
static inline GeeConcurrentSetState gee_concurrent_set_tower_get_state (GeeConcurrentSetTower* self,
                                                          guint8 level);
static inline gboolean gee_concurrent_set_tower_remove_level (GCompareDataFunc cmp,
                                                gpointer cmp_target,
                                                GeeConcurrentSetTower* * prev,
                                                GeeConcurrentSetTower* curr,
                                                guint8 level);
                                   ...
                                   gconstpointer start)
{
	...
	GeeConcurrentSet* _tmp0_;
	GeeConcurrentSetRange* _tmp1_;
	GeeConcurrentSetRangeType _tmp2_;
	GeeConcurrentSetRange* _tmp33_;
	GeeConcurrentSetRangeType _tmp34_;
	...
	switch (_tmp2_) {
		case GEE_CONCURRENT_SET_RANGE_TYPE_HEAD:
		{
			...
			_tmp5_ = from->_end;
			if (_tmp4_ (start, _tmp5_, _tmp4__target) < 0) {
				GeeConcurrentSetRange* _tmp6_;
				gpointer _tmp7_;
				GeeConcurrentSetRange* _tmp8_;
				gconstpointer _tmp9_;
				...
				GeeConcurrentSetRange* _tmp11_;
				_tmp6_ = _result_;
				_tmp7_ = ((start != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) start) : ((gpointer) start);
				((_tmp6_->_start == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp6_->_start = (g_destroy_func (_tmp6_->_start), NULL));
				_tmp6_->_start = _tmp7_;
				_tmp8_ = _result_;
				_tmp9_ = from->_end;
				_tmp10_ = ((_tmp9_ != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) _tmp9_) : ((gpointer) _tmp9_);
				((_tmp8_->_end == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp8_->_end = (g_destroy_func (_tmp8_->_end), NULL));
				_tmp8_->_end = _tmp10_;
				_tmp11_ = _result_;
				_tmp11_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED;
			} else {
				GeeConcurrentSetRange* _tmp12_;
				_tmp12_ = _result_;
				_tmp12_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY;
			}
			break;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp14_ = from->_set;
			_tmp15_ = from->_start;
			_tmp16_ = gee_concurrent_set_max (_tmp14_, _tmp15_, start, NULL);
			_tmp17_ = ((_tmp16_ != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) _tmp16_) : ((gpointer) _tmp16_);
			((_tmp13_->_start == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp13_->_start = (g_destroy_func (_tmp13_->_start), NULL));
			_tmp13_->_start = _tmp17_;
			_tmp18_ = _result_;
			_tmp18_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_TAIL;
			break;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			...
			gconstpointer _tmp21_;
			_tmp19_ = from->_set;
			_tmp20_ = _tmp19_->priv->_cmp;
			_tmp20__target = _tmp19_->priv->_cmp_target;
			_tmp21_ = from->_start;
			if (_tmp20_ (_tmp21_, start, _tmp20__target) < 0) {
				...
				_tmp23_ = from->_set;
				_tmp24_ = from->_start;
				_tmp25_ = gee_concurrent_set_max (_tmp23_, _tmp24_, start, NULL);
				_tmp26_ = ((_tmp25_ != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) _tmp25_) : ((gpointer) _tmp25_);
				((_tmp22_->_start == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp22_->_start = (g_destroy_func (_tmp22_->_start), NULL));
				_tmp22_->_start = _tmp26_;
				_tmp27_ = _result_;
				_tmp28_ = from->_end;
				_tmp29_ = ((_tmp28_ != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) _tmp28_) : ((gpointer) _tmp28_);
				((_tmp27_->_end == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp27_->_end = (g_destroy_func (_tmp27_->_end), NULL));
				_tmp27_->_end = _tmp29_;
				_tmp30_ = _result_;
				_tmp30_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED;
			} else {
		...
		case GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY:
		{
			...
			_tmp32_ = _result_;
			_tmp32_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY;
			break;
		}
		default:
		{
	...
	_tmp33_ = _result_;
	_tmp34_ = _tmp33_->_type;
	if (_tmp34_ != GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY) {
		GeeConcurrentSetRange* _tmp35_;
		GeeConcurrentSetRange* _tmp36_;
		gee_concurrent_set_range_improve_bookmark (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, from, NULL, NULL);
		_tmp35_ = _result_;
		gee_concurrent_set_range_copy_bookmark (_tmp35_, from);
		_tmp36_ = _result_;
		gee_concurrent_set_range_improve_bookmark (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp36_, NULL, NULL);
	}
	result = _result_;
	return result;
}
                                   ...
                                   gconstpointer end)
{
	...
	switch (_tmp2_) {
		case GEE_CONCURRENT_SET_RANGE_TYPE_HEAD:
		{
			...
			_tmp4_ = from->_set;
			_tmp5_ = from->_end;
			_tmp6_ = gee_concurrent_set_min (_tmp4_, _tmp5_, end, NULL);
			_tmp7_ = ((_tmp6_ != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) _tmp6_) : ((gpointer) _tmp6_);
			((_tmp3_->_end == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp3_->_end = (g_destroy_func (_tmp3_->_end), NULL));
			_tmp3_->_end = _tmp7_;
			_tmp8_ = _result_;
			_tmp8_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_HEAD;
			break;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp11_ = from->_start;
			if (_tmp10_ (_tmp11_, end, _tmp10__target) < 0) {
				GeeConcurrentSetRange* _tmp12_;
				gconstpointer _tmp13_;
				gpointer _tmp14_;
				GeeConcurrentSetRange* _tmp15_;
				...
				_tmp15_ = _result_;
				_tmp16_ = ((end != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) end) : ((gpointer) end);
				((_tmp15_->_end == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp15_->_end = (g_destroy_func (_tmp15_->_end), NULL));
				_tmp15_->_end = _tmp16_;
				_tmp17_ = _result_;
				_tmp17_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED;
			} else {
				GeeConcurrentSetRange* _tmp18_;
				_tmp18_ = _result_;
				_tmp18_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY;
			}
			break;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			...
			_tmp20__target = _tmp19_->priv->_cmp_target;
			_tmp21_ = from->_start;
			if (_tmp20_ (_tmp21_, end, _tmp20__target) < 0) {
				GeeConcurrentSetRange* _tmp22_;
				gconstpointer _tmp23_;
				gpointer _tmp24_;
				GeeConcurrentSetRange* _tmp25_;
				GeeConcurrentSet* _tmp26_;
				...
				((_tmp22_->_start == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp22_->_start = (g_destroy_func (_tmp22_->_start), NULL));
				_tmp22_->_start = _tmp24_;
				_tmp25_ = _result_;
				_tmp26_ = from->_set;
				_tmp27_ = from->_end;
				_tmp28_ = gee_concurrent_set_min (_tmp26_, _tmp27_, end, NULL);
				_tmp29_ = ((_tmp28_ != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) _tmp28_) : ((gpointer) _tmp28_);
				((_tmp25_->_end == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp25_->_end = (g_destroy_func (_tmp25_->_end), NULL));
				_tmp25_->_end = _tmp29_;
				_tmp30_ = _result_;
				_tmp30_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED;
			} else {
				GeeConcurrentSetRange* _tmp31_;
                              ...
                              gconstpointer end)
{
	...
	GeeConcurrentSetRange* _tmp1_;
	GeeConcurrentSetRange* _tmp2_;
	GeeConcurrentSetRangeType _tmp3_;
	gboolean _tmp17_ = FALSE;
	GeeConcurrentSetRange* _tmp18_;
	GeeConcurrentSetRangeType _tmp19_;
	GeeConcurrentSetRange* _tmp28_;
	GeeConcurrentSetRangeType _tmp29_;
	GeeConcurrentSetRange* result = NULL;
	g_return_val_if_fail (from != NULL, NULL);
	_tmp0_ = from->_set;
	_tmp1_ = gee_concurrent_set_range_new_empty (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp0_);
	...
	switch (_tmp3_) {
		...
		case GEE_CONCURRENT_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp7_ = from->_set;
			_tmp8_ = from->_start;
			_tmp9_ = gee_concurrent_set_max (_tmp7_, _tmp8_, start, NULL);
			start = _tmp9_;
			break;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			...
			_tmp10_ = from->_set;
			_tmp11_ = from->_start;
			_tmp12_ = gee_concurrent_set_max (_tmp10_, _tmp11_, start, NULL);
			start = _tmp12_;
			_tmp13_ = from->_set;
			_tmp14_ = from->_end;
			_tmp15_ = gee_concurrent_set_min (_tmp13_, _tmp14_, end, NULL);
			end = _tmp15_;
			break;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY:
		{
			GeeConcurrentSetRange* _tmp16_;
			_tmp16_ = _result_;
			_tmp16_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY;
			break;
		}
		default:
		{
	...
	_tmp18_ = _result_;
	_tmp19_ = _tmp18_->_type;
	if (_tmp19_ != GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY) {
		...
		_tmp17_ = _tmp21_ (start, end, _tmp21__target) < 0;
	} else {
		_tmp17_ = FALSE;
	}
	if (_tmp17_) {
		...
		GeeConcurrentSetRange* _tmp26_;
		_tmp22_ = _result_;
		_tmp23_ = ((start != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) start) : ((gpointer) start);
		((_tmp22_->_start == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp22_->_start = (g_destroy_func (_tmp22_->_start), NULL));
		_tmp22_->_start = _tmp23_;
		_tmp24_ = _result_;
		_tmp25_ = ((end != NULL) && (g_dup_func != NULL)) ? g_dup_func ((gpointer) end) : ((gpointer) end);
		((_tmp24_->_end == NULL) || (g_destroy_func == NULL)) ? NULL : (_tmp24_->_end = (g_destroy_func (_tmp24_->_end), NULL));
		_tmp24_->_end = _tmp25_;
		_tmp26_ = _result_;
		_tmp26_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED;
	} else {
		GeeConcurrentSetRange* _tmp27_;
		_tmp27_ = _result_;
		_tmp27_->_type = GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY;
	}
	_tmp28_ = _result_;
	_tmp29_ = _tmp28_->_type;
	if (_tmp29_ != GEE_CONCURRENT_SET_RANGE_TYPE_EMPTY) {
		GeeConcurrentSetRange* _tmp30_;
		GeeConcurrentSetRange* _tmp31_;
		gee_concurrent_set_range_improve_bookmark (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, from, NULL, NULL);
		_tmp30_ = _result_;
		gee_concurrent_set_range_copy_bookmark (_tmp30_, from);
		_tmp31_ = _result_;
		gee_concurrent_set_range_improve_bookmark (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp31_, NULL, NULL);
	}
	result = _result_;
	return result;
}
                                           ...
                                           GeeConcurrentSetTowerIter* prev)
{
	...
	GeeConcurrentSetRangeType _tmp0_;
	...
	switch (_tmp0_) {
		case GEE_CONCURRENT_SET_RANGE_TYPE_HEAD:
		{
			if ((&_vala_out_curr) != NULL) {
				gpointer _tmp1_;
				_tmp1_ = gee_hazard_pointer_get_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[0], (gsize) 0, NULL);
				_gee_concurrent_set_tower_unref0 (_vala_out_curr);
				_vala_out_curr = (GeeConcurrentSetTower*) _tmp1_;
				if ((&_vala_prev) != NULL) {
					GeeConcurrentSetTower* _tmp2_;
					GeeConcurrentSetTowerIter _tmp3_;
					GeeConcurrentSetTower* _tmp4_;
					GeeConcurrentSetTower* _tmp5_;
					_tmp2_ = _vala_out_curr;
					_vala_out_curr = NULL;
					_gee_concurrent_set_tower_unref0 (_vala_prev._iter[0]);
					_vala_prev._iter[0] = _tmp2_;
					_tmp3_ = _vala_prev;
					_tmp4_ = _tmp3_._iter[0];
					_tmp5_ = gee_concurrent_set_tower_get_next (_tmp4_, (guint8) 0);
					_gee_concurrent_set_tower_unref0 (_vala_out_curr);
					_vala_out_curr = _tmp5_;
				} else {
					GeeConcurrentSetTower* _tmp6_;
					GeeConcurrentSetTower* _tmp7_;
					_tmp6_ = _vala_out_curr;
					_tmp7_ = gee_concurrent_set_tower_get_next (_tmp6_, (guint8) 0);
					_gee_concurrent_set_tower_unref0 (_vala_out_curr);
					_vala_out_curr = _tmp7_;
				}
			}
			if ((&_vala_prev) != NULL) {
				{
					...
					i = _tmp8_;
					{
						...
						while (TRUE) {
							...
							_tmp11_ = gee_hazard_pointer_get_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[i], (gsize) 0, NULL);
							_gee_concurrent_set_tower_unref0 (_vala_prev._iter[i]);
							_vala_prev._iter[i] = (GeeConcurrentSetTower*) _tmp11_;
						}
					}
				}
			}
			...
			last_best = NULL;
			{
				...
				i = GEE_CONCURRENT_SET__MAX_HEIGHT - 1;
				{
					...
					while (TRUE) {
						...
						_tmp14_ = gee_hazard_pointer_get_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[i], (gsize) 0, NULL);
						curr = (GeeConcurrentSetTower*) _tmp14_;
						_tmp15_ = curr;
						_tmp16_ = _gee_concurrent_set_tower_ref0 (_tmp15_);
						curr_old = _tmp16_;
						_tmp17_ = curr;
						_vala_assert (_tmp17_ != NULL, "curr != null");
						...
						if (_tmp19_) {
							...
							GeeConcurrentSetTower* _tmp26_;
							_tmp23_ = range->_set;
							_tmp24_ = _tmp23_->priv->_cmp;
							_tmp24__target = _tmp23_->priv->_cmp_target;
							_tmp25_ = curr;
							_tmp26_ = last_best;
							_tmp18_ = gee_concurrent_set_tower_compare (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp24_, _tmp24__target, _tmp25_, _tmp26_) < 0;
						} else {
							_tmp18_ = FALSE;
						}
						if (_tmp18_) {
						...
						if (_tmp29_ != _tmp30_) {
							...
							_tmp31_ = curr_old;
							_tmp32_ = curr;
							_tmp33_ = _gee_concurrent_set_tower_ref0 (_tmp32_);
							if (!gee_hazard_pointer_compare_and_exchange_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[i], _tmp31_, _tmp33_, (gsize) 0, (gsize) 0, (gsize) 0)) {
								gpointer _tmp34_;
								_tmp34_ = gee_hazard_pointer_get_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[i], (gsize) 0, NULL);
								_gee_concurrent_set_tower_unref0 (curr);
								curr = (GeeConcurrentSetTower*) _tmp34_;
							}
						}
						_tmp35_ = curr;
						_tmp36_ = gee_concurrent_set_tower_get_next (_tmp35_, (guint8) i);
						next = _tmp36_;
						if ((&_vala_out_curr) != NULL) {
							_tmp37_ = i == 0;
						} else {
						...
						if (_tmp37_) {
							...
							_gee_concurrent_set_tower_unref0 (_vala_out_curr);
							_vala_out_curr = _tmp39_;
						}
						while (TRUE) {
							gboolean _tmp40_ = FALSE;
							GeeConcurrentSetTower* _tmp41_;
							GeeConcurrentSet* _tmp46_;
							GCompareDataFunc _tmp47_;
							gpointer _tmp47__target;
							gboolean _tmp48_ = FALSE;
							gboolean _tmp49_ = FALSE;
							GeeConcurrentSet* _tmp53_;
							GCompareDataFunc _tmp54_;
							...
							if (_tmp41_ != NULL) {
								...
								GCompareDataFunc _tmp43_;
								gpointer _tmp43__target;
								GeeConcurrentSetTower* _tmp44_;
								gconstpointer _tmp45_;
								_tmp42_ = range->_set;
								_tmp43_ = _tmp42_->priv->_cmp;
								_tmp43__target = _tmp42_->priv->_cmp_target;
								_tmp44_ = next;
								_tmp45_ = range->_start;
								_tmp40_ = gee_concurrent_set_tower_compare_data (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp43_, _tmp43__target, _tmp44_, _tmp45_) < 0;
							} else {
								_tmp40_ = FALSE;
							}
							if (!_tmp40_) {
							...
							_tmp46_ = range->_set;
							_tmp47_ = _tmp46_->priv->_cmp;
							_tmp47__target = _tmp46_->priv->_cmp_target;
							gee_concurrent_set_tower_proceed (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp47_, _tmp47__target, &curr, &next, (guint8) i, TRUE);
							if ((&curr) != NULL) {
								_tmp49_ = i == 0;
							} else {
								_tmp49_ = FALSE;
							...
							if (_tmp48_) {
								...
								_tmp51_ = next;
								_tmp52_ = _gee_concurrent_set_tower_ref0 (_tmp51_);
								_gee_concurrent_set_tower_unref0 (_vala_out_curr);
								_vala_out_curr = _tmp52_;
							}
							_tmp53_ = range->_set;
							_tmp54_ = _tmp53_->priv->_cmp;
							_tmp54__target = _tmp53_->priv->_cmp_target;
							_tmp55_ = curr;
							_tmp56_ = range->_start;
							if (gee_concurrent_set_tower_compare_data (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp54_, _tmp54__target, _tmp55_, _tmp56_) < 0) {
								...
								_tmp57_ = curr_old;
								_tmp58_ = curr;
								_tmp59_ = _gee_concurrent_set_tower_ref0 (_tmp58_);
								if (!gee_hazard_pointer_compare_and_exchange_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[i], _tmp57_, _tmp59_, (gsize) 0, (gsize) 0, (gsize) 0)) {
									gpointer _tmp60_;
									_tmp60_ = gee_hazard_pointer_get_pointer (GEE_CONCURRENT_SET_TYPE_TOWER, (GBoxedCopyFunc) gee_concurrent_set_tower_ref, (GDestroyNotify) gee_concurrent_set_tower_unref, &range->_bookmark._iter[i], (gsize) 0, NULL);
									_gee_concurrent_set_tower_unref0 (curr);
									curr = (GeeConcurrentSetTower*) _tmp60_;
								}
								_tmp61_ = curr;
								_tmp62_ = _gee_concurrent_set_tower_ref0 (_tmp61_);
						...
						if ((&_vala_prev) != NULL) {
							...
							_tmp63_ = curr;
							_tmp64_ = _gee_concurrent_set_tower_ref0 (_tmp63_);
							_gee_concurrent_set_tower_unref0 (_vala_prev._iter[i]);
							_vala_prev._iter[i] = _tmp64_;
						}
						_tmp65_ = curr;
						curr = NULL;
	...
	if (_tmp67_) {
		GeeConcurrentSetTower* _tmp69_;
		_tmp69_ = _vala_out_curr;
		_tmp66_ = gee_concurrent_set_range_beyond (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, range, _tmp69_);
	} else {
		_tmp66_ = FALSE;
	}
	if (_tmp66_) {
                                  ...
                                  guint8 level)
{
	...
	switch (_tmp0_) {
		...
		case GEE_CONCURRENT_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp3_ = gee_concurrent_set_tower_proceed (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp2_, _tmp2__target, prev, curr, level, FALSE);
			result = _tmp3_;
			return result;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_HEAD:
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			...
			gpointer _tmp7__target;
			gboolean _tmp8_;
			_tmp4_ = _gee_concurrent_set_tower_ref0 (*prev);
			tmp_prev = _tmp4_;
			_tmp5_ = _gee_concurrent_set_tower_ref0 (*curr);
			tmp_curr = _tmp5_;
			_tmp6_ = range->_set;
			_tmp7_ = _tmp6_->priv->_cmp;
			_tmp7__target = _tmp6_->priv->_cmp_target;
			_tmp8_ = gee_concurrent_set_tower_proceed (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp7_, _tmp7__target, &tmp_prev, &tmp_curr, level, FALSE);
			if (!_tmp8_) {
				result = FALSE;
				...
				_tmp11_ = tmp_curr;
				_tmp12_ = range->_end;
				if (gee_concurrent_set_tower_compare_data (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp10_, _tmp10__target, _tmp11_, _tmp12_) >= 0) {
					result = FALSE;
					_gee_concurrent_set_tower_unref0 (tmp_curr);
					_gee_concurrent_set_tower_unref0 (tmp_prev);
					return result;
                                 ...
                                 gconstpointer val)
{
	...
	switch (_tmp0_) {
		case GEE_CONCURRENT_SET_RANGE_TYPE_HEAD:
		{
			...
			_tmp2__target = _tmp1_->priv->_cmp_target;
			_tmp3_ = range->_end;
			result = _tmp2_ (val, _tmp3_, _tmp2__target) < 0;
			return result;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp5__target = _tmp4_->priv->_cmp_target;
			_tmp6_ = range->_start;
			result = _tmp5_ (val, _tmp6_, _tmp5__target) >= 0;
			return result;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			...
			_tmp10_ = range->_start;
			if (_tmp9_ (val, _tmp10_, _tmp9__target) >= 0) {
				GeeConcurrentSet* _tmp11_;
				GCompareDataFunc _tmp12_;
				gpointer _tmp12__target;
				gconstpointer _tmp13_;
				_tmp11_ = range->_set;
				_tmp12_ = _tmp11_->priv->_cmp;
				_tmp12__target = _tmp11_->priv->_cmp_target;
				_tmp13_ = range->_end;
				_tmp7_ = _tmp12_ (val, _tmp13_, _tmp12__target) < 0;
			} else {
				_tmp7_ = FALSE;
			}
			result = _tmp7_;
                                 ...
                                 GeeConcurrentSetTower* tw)
{
	...
	switch (_tmp0_) {
		...
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			...
			_tmp2__target = _tmp1_->priv->_cmp_target;
			_tmp3_ = range->_end;
			result = gee_concurrent_set_tower_compare_data (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, _tmp2_, _tmp2__target, tw, _tmp3_) >= 0;
			return result;
		}
		default:
		{
                              ...
                              gconstpointer val)
{
	...
	switch (_tmp0_) {
		case GEE_CONCURRENT_SET_RANGE_TYPE_HEAD:
		{
			GeeConcurrentSetRangePosition _tmp1_ = 0;
			GeeConcurrentSet* _tmp2_;
			GCompareDataFunc _tmp3_;
			gpointer _tmp3__target;
			...
			_tmp4_ = range->_end;
			if (_tmp3_ (val, _tmp4_, _tmp3__target) < 0) {
				_tmp1_ = GEE_CONCURRENT_SET_RANGE_POSITION_INSIDE;
			} else {
				_tmp1_ = GEE_CONCURRENT_SET_RANGE_POSITION_AFTER;
			}
			result = (gint) _tmp1_;
			return result;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_TAIL:
		{
			GeeConcurrentSetRangePosition _tmp5_ = 0;
			GeeConcurrentSet* _tmp6_;
			GCompareDataFunc _tmp7_;
			gpointer _tmp7__target;
			gconstpointer _tmp8_;
			...
			_tmp7__target = _tmp6_->priv->_cmp_target;
			_tmp8_ = range->_start;
			if (_tmp7_ (val, _tmp8_, _tmp7__target) >= 0) {
				_tmp5_ = GEE_CONCURRENT_SET_RANGE_POSITION_INSIDE;
			} else {
				_tmp5_ = GEE_CONCURRENT_SET_RANGE_POSITION_BEFORE;
			}
			result = (gint) _tmp5_;
			return result;
		}
		case GEE_CONCURRENT_SET_RANGE_TYPE_BOUNDED:
		{
			GeeConcurrentSetRangePosition _tmp9_ = 0;
			GeeConcurrentSet* _tmp10_;
			GCompareDataFunc _tmp11_;
			gpointer _tmp11__target;
			gconstpointer _tmp12_;
			...
			_tmp12_ = range->_start;
			if (_tmp11_ (val, _tmp12_, _tmp11__target) >= 0) {
				GeeConcurrentSetRangePosition _tmp13_ = 0;
				GeeConcurrentSet* _tmp14_;
				...
				_tmp16_ = range->_end;
				if (_tmp15_ (val, _tmp16_, _tmp15__target) < 0) {
					_tmp13_ = GEE_CONCURRENT_SET_RANGE_POSITION_INSIDE;
				} else {
					_tmp13_ = GEE_CONCURRENT_SET_RANGE_POSITION_AFTER;
				}
				_tmp9_ = _tmp13_;
			} else {
				_tmp9_ = GEE_CONCURRENT_SET_RANGE_POSITION_BEFORE;
			}
			result = (gint) _tmp9_;
			return result;
		}
                                        ...
                                        guint8 level)
{
	...
	while (TRUE) {
		...
		prev_next = _tmp15_;
		_tmp16_ = prev_state;
		if (_tmp16_ == GEE_CONCURRENT_SET_STATE_FLAGGED) {
			GeeConcurrentSetTower* _tmp17_;
			GeeConcurrentSetTowerIter _tmp18_;
			GeeConcurrentSetTower* _tmp19_;
			_tmp17_ = prev_next;
			_tmp18_ = *prev;
			_tmp19_ = _tmp18_._iter[level];
			gee_concurrent_set_tower_help_flagged (_tmp17_, _tmp19_, level);
		} else {
			GeeConcurrentSetTower* _tmp20_;
			GeeConcurrentSetTower* _tmp21_;
			gboolean _result_ = FALSE;
			...
			GeeConcurrentSetTower* _tmp27_;
			GeeConcurrentSetState _tmp28_ = 0;
			GeeConcurrentSetTower* _tmp29_;
			GeeConcurrentSetState _tmp30_;
			_tmp20_ = new_tower;
			_tmp21_ = next;
			gee_concurrent_set_tower_set_succ (_tmp20_, _tmp21_, GEE_CONCURRENT_SET_STATE_NONE, level);
			_tmp22_ = *prev;
			_tmp23_ = _tmp22_._iter[level];
			_tmp24_ = next;
			_tmp25_ = new_tower;
			_result_ = gee_concurrent_set_tower_compare_and_exchange (_tmp23_, _tmp24_, GEE_CONCURRENT_SET_STATE_NONE, _tmp25_, GEE_CONCURRENT_SET_STATE_NONE, level);
			if (_result_) {
				_gee_concurrent_set_tower_unref0 (prev_next);
				break;
			}
			_tmp26_ = *prev;
			_tmp27_ = _tmp26_._iter[level];
			_tmp29_ = gee_concurrent_set_tower_get_succ (_tmp27_, &_tmp28_, level);
			prev_state = _tmp28_;
			_gee_concurrent_set_tower_unref0 (prev_next);
			prev_next = _tmp29_;
			_tmp30_ = prev_state;
			if (_tmp30_ == GEE_CONCURRENT_SET_STATE_FLAGGED) {
				GeeConcurrentSetTower* _tmp31_;
				GeeConcurrentSetTowerIter _tmp32_;
				GeeConcurrentSetTower* _tmp33_;
				_tmp31_ = prev_next;
				_tmp32_ = *prev;
				_tmp33_ = _tmp32_._iter[level];
				gee_concurrent_set_tower_help_flagged (_tmp31_, _tmp33_, level);
			}
			gee_concurrent_set_tower_backtrace (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, &(*prev)._iter[level], level);
		}
		_tmp34_ = gee_concurrent_set_tower_search_helper (g_type, (GBoxedCopyFunc) g_dup_func, (GDestroyNotify) g_destroy_func, cmp, cmp_target, key, &(*prev)._iter[level], NULL, level);
		if (_tmp34_) {
			result = NULL;
			_gee_concurrent_set_tower_unref0 (prev_next);
			_gee_concurrent_set_tower_unref0 (next);
	...
	_tmp35_ = new_tower;
	g_atomic_int_inc ((volatile gint *) (&_tmp35_->_height));
	_tmp36_ = new_tower;
	if (gee_concurrent_set_tower_get_state (_tmp36_, (guint8) 0) == GEE_CONCURRENT_SET_STATE_MARKED) {
		GeeConcurrentSetTower* _tmp37_;
		_tmp37_ = new_tower;
		gee_concurrent_set_tower_remove_level (cmp, cmp_target, &(*prev)._iter[level], _tmp37_, level);
		result = NULL;
		_gee_concurrent_set_tower_unref0 (next);
		_gee_concurrent_set_tower_unref0 (new_tower);
		return result;
                                 ...
                                 GeeConcurrentSetTower* curr)
{
	...
	g_return_val_if_fail (prev != NULL, FALSE);
	g_return_val_if_fail (curr != NULL, FALSE);
	_tmp0_ = gee_concurrent_set_tower_remove_level (cmp, cmp_target, &(*prev)._iter[0], curr, (guint8) 0);
	removed = _tmp0_;
	{
		gint i = 0;
		i = 1;
		{
			...
			while (TRUE) {
				...
				gee_concurrent_set_tower_remove_level (cmp, cmp_target, &(*prev)._iter[i], curr, (guint8) i);
			}
		}
	}
	result = removed;
...
static inline gboolean
gee_concurrent_set_tower_remove_level (GCompareDataFunc cmp,
                                       gpointer cmp_target,
                                       GeeConcurrentSetTower* * prev,
                                       GeeConcurrentSetTower* curr,
                                       guint8 level)
	...
	g_return_if_fail (self != NULL);
	{
		...
		while (TRUE) {
			...
			if (!_result_) {
				...
				next_tower = _tmp5_;
				_tmp6_ = state;
				if (_tmp6_ == GEE_CONCURRENT_SET_STATE_FLAGGED) {
					GeeConcurrentSetTower* _tmp7_;
					_tmp7_ = next_tower;
					gee_concurrent_set_tower_help_flagged (self, _tmp7_, level);
				}
			}
			_gee_concurrent_set_tower_unref0 (next_tower);
		}
                                   ...
                                   guint8 level)
{
	...
	while (TRUE) {
		...
		if (_tmp3_ == self) {
			...
			_tmp4_ = result_state;
			_tmp2_ = _tmp4_ == GEE_CONCURRENT_SET_STATE_FLAGGED;
		} else {
			_tmp2_ = FALSE;
		}
		if (_tmp2_) {
		...
		_tmp5_ = self->_data;
		_tmp6_ = gee_concurrent_set_tower_search_helper (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, cmp, cmp_target, _tmp5_, prev_tower, NULL, level);
		if (!_tmp6_) {
			_vala_status = FALSE;
			result = FALSE;
			_gee_concurrent_set_tower_unref0 (result_tower);
