/* gee.h generated by valac 0.52.0, the Vala compiler, do not modify */
...
GeeAbstractBidirSortedSet* gee_abstract_bidir_sorted_set_construct (GType object_type,
                                                                    GType g_type,
                                                                    GBoxedCopyFunc g_dup_func,
                                                                    GDestroyNotify g_destroy_func);
...
GeeAbstractBidirSortedMap* gee_abstract_bidir_sorted_map_construct (GType object_type,
                                                                    GType k_type,
...
gboolean gee_abstract_collection_contains (GeeAbstractCollection* self,
                                           gconstpointer item);
gboolean gee_abstract_collection_add (GeeAbstractCollection* self,
                                      gconstpointer item);
gboolean gee_abstract_collection_remove (GeeAbstractCollection* self,
                                         gconstpointer item);
...
gboolean gee_abstract_collection_foreach (GeeAbstractCollection* self,
                                          GeeForallFunc f,
                                          gpointer f_target);
GeeAbstractCollection* gee_abstract_collection_construct (GType object_type,
                                                          GType g_type,
                                                          GBoxedCopyFunc g_dup_func,
                                                          GDestroyNotify g_destroy_func);
...
gpointer gee_abstract_list_get (GeeAbstractList* self,
                                gint index);
void gee_abstract_list_set (GeeAbstractList* self,
                            gint index,
                            gconstpointer item);
...
gpointer gee_abstract_list_remove_at (GeeAbstractList* self,
                                      gint index);
GeeList* gee_abstract_list_slice (GeeAbstractList* self,
                                  gint start,
                                  gint stop);
GeeAbstractList* gee_abstract_list_construct (GType object_type,
                                              GType g_type,
                                              GBoxedCopyFunc g_dup_func,
                                              GDestroyNotify g_destroy_func);
GeeList* gee_abstract_list_get_read_only_view (GeeAbstractList* self);
gboolean gee_abstract_map_has_key (GeeAbstractMap* self,
                                   gconstpointer key);
gboolean gee_abstract_map_has (GeeAbstractMap* self,
                               gconstpointer key,
                               gconstpointer value);
gpointer gee_abstract_map_get (GeeAbstractMap* self,
                               gconstpointer key);
void gee_abstract_map_set (GeeAbstractMap* self,
                           gconstpointer key,
                           gconstpointer value);
gboolean gee_abstract_map_unset (GeeAbstractMap* self,
                                 gconstpointer key,
                                 gpointer* value);
GeeMapIterator* gee_abstract_map_map_iterator (GeeAbstractMap* self);
void gee_abstract_map_clear (GeeAbstractMap* self);
gboolean gee_abstract_map_foreach (GeeAbstractMap* self,
                                   GeeForallFunc f,
                                   gpointer f_target);
GeeIterator* gee_abstract_map_stream (GeeAbstractMap* self,
                                      GType a_type,
...
GeeAbstractMap* gee_abstract_map_construct (GType object_type,
                                            GType k_type,
                                            GBoxedCopyFunc k_dup_func,
                                            GDestroyNotify k_destroy_func,
                                            GType v_type,
...
GeeAbstractMultiMap* gee_abstract_multi_map_construct (GType object_type,
                                                       GType k_type,
                                                       GBoxedCopyFunc k_dup_func,
                                                       GDestroyNotify k_destroy_func,
                                                       GType v_type,
...
GeeEqualDataFunc gee_abstract_multi_map_get_value_equal_func (GeeAbstractMultiMap* self,
...
GeeAbstractMultiSet* gee_abstract_multi_set_construct (GType object_type,
                                                       GType g_type,
                                                       GBoxedCopyFunc g_dup_func,
                                                       GDestroyNotify g_destroy_func,
                                                       GeeMap* storage_map);
...
GeeAbstractSet* gee_abstract_set_construct (GType object_type,
                                            GType g_type,
                                            GBoxedCopyFunc g_dup_func,
                                            GDestroyNotify g_destroy_func);
GeeSet* gee_abstract_set_get_read_only_view (GeeAbstractSet* self);
GeeSortedMap* gee_abstract_sorted_map_head_map (GeeAbstractSortedMap* self,
                                                gconstpointer before);
GeeSortedMap* gee_abstract_sorted_map_tail_map (GeeAbstractSortedMap* self,
                                                gconstpointer after);
GeeSortedMap* gee_abstract_sorted_map_sub_map (GeeAbstractSortedMap* self,
                                               gconstpointer before,
                                               gconstpointer after);
GeeAbstractSortedMap* gee_abstract_sorted_map_construct (GType object_type,
                                                         GType k_type,
                                                         GBoxedCopyFunc k_dup_func,
                                                         GDestroyNotify k_destroy_func,
                                                         GType v_type,
...
GeeIterator* gee_abstract_sorted_set_iterator_at (GeeAbstractSortedSet* self,
                                                  gconstpointer element);
gpointer gee_abstract_sorted_set_lower (GeeAbstractSortedSet* self,
                                        gconstpointer element);
gpointer gee_abstract_sorted_set_higher (GeeAbstractSortedSet* self,
                                         gconstpointer element);
gpointer gee_abstract_sorted_set_floor (GeeAbstractSortedSet* self,
                                        gconstpointer element);
gpointer gee_abstract_sorted_set_ceil (GeeAbstractSortedSet* self,
                                       gconstpointer element);
GeeSortedSet* gee_abstract_sorted_set_head_set (GeeAbstractSortedSet* self,
                                                gconstpointer before);
GeeSortedSet* gee_abstract_sorted_set_tail_set (GeeAbstractSortedSet* self,
                                                gconstpointer after);
GeeSortedSet* gee_abstract_sorted_set_sub_set (GeeAbstractSortedSet* self,
                                               gconstpointer from,
                                               gconstpointer to);
GeeAbstractSortedSet* gee_abstract_sorted_set_construct (GType object_type,
                                                         GType g_type,
                                                         GBoxedCopyFunc g_dup_func,
                                                         GDestroyNotify g_destroy_func);
...
GeeArrayList* gee_array_list_construct (GType object_type,
                                        ...
                                        gpointer equal_func_target,
                                        GDestroyNotify equal_func_target_destroy_notify);
GeeArrayList* gee_array_list_new_wrap (GType g_type,
                                       GBoxedCopyFunc g_dup_func,
                                       GDestroyNotify g_destroy_func,
                                       gpointer* items,
                                       gint items_length1,
                                       ...
                                       gpointer equal_func_target,
                                       GDestroyNotify equal_func_target_destroy_notify);
GeeArrayList* gee_array_list_construct_wrap (GType object_type,
                                             GType g_type,
                                             GBoxedCopyFunc g_dup_func,
                                             GDestroyNotify g_destroy_func,
                                             gpointer* items,
                                             ...
                                             gpointer equal_func_target,
                                             GDestroyNotify equal_func_target_destroy_notify);
gboolean gee_array_list_add_all (GeeArrayList* self,
                                 GeeCollection* collection);
GeeEqualDataFunc gee_array_list_get_equal_func (GeeArrayList* self,
                                                gpointer* result_target);
...
void gee_bidir_list_iterator_insert (GeeBidirListIterator* self,
                                     gconstpointer item);
...
GeeBidirSortedSet* gee_bidir_sorted_set_empty (GType g_type,
                                               GBoxedCopyFunc g_dup_func,
                                               GDestroyNotify g_destroy_func);
...
GeeBidirSortedMap* gee_bidir_sorted_map_empty (GType k_type,
                                               GBoxedCopyFunc k_dup_func,
                                               GDestroyNotify k_destroy_func,
                                               GType v_type,
                                               GBoxedCopyFunc v_dup_func,
...
gboolean gee_collection_contains (GeeCollection* self,
                                  gconstpointer item);
gboolean gee_collection_add (GeeCollection* self,
                             gconstpointer item);
gboolean gee_collection_remove (GeeCollection* self,
                                gconstpointer item);
void gee_collection_clear (GeeCollection* self);
gboolean gee_collection_add_all (GeeCollection* self,
                                 GeeCollection* collection);
gboolean gee_collection_contains_all (GeeCollection* self,
                                      GeeCollection* collection);
gboolean gee_collection_remove_all (GeeCollection* self,
                                    GeeCollection* collection);
gboolean gee_collection_retain_all (GeeCollection* self,
                                    GeeCollection* collection);
gpointer* gee_collection_to_array (GeeCollection* self,
                                   gint* result_length1);
gboolean gee_collection_add_all_array (GeeCollection* self,
                                       gpointer* array,
                                       gint array_length1);
gboolean gee_collection_contains_all_array (GeeCollection* self,
                                            gpointer* array,
                                            gint array_length1);
gboolean gee_collection_remove_all_array (GeeCollection* self,
                                          gpointer* array,
                                          gint array_length1);
gboolean gee_collection_add_all_iterator (GeeCollection* self,
                                          GeeIterator* iter);
gboolean gee_collection_contains_all_iterator (GeeCollection* self,
                                               GeeIterator* iter);
gboolean gee_collection_remove_all_iterator (GeeCollection* self,
                                             GeeIterator* iter);
GeeCollection* gee_collection_empty (GType g_type,
                                     GBoxedCopyFunc g_dup_func,
                                     GDestroyNotify g_destroy_func);
...
GeeConcurrentList* gee_concurrent_list_new (GType g_type,
                                            GBoxedCopyFunc g_dup_func,
                                            GDestroyNotify g_destroy_func,
                                            GeeEqualDataFunc equal_func,
                                            gpointer equal_func_target,
                                            GDestroyNotify equal_func_target_destroy_notify);
GeeConcurrentList* gee_concurrent_list_construct (GType object_type,
                                                  GType g_type,
                                                  GBoxedCopyFunc g_dup_func,
                                                  GDestroyNotify g_destroy_func,
                                                  GeeEqualDataFunc equal_func,
                                                  gpointer equal_func_target,
                                                  GDestroyNotify equal_func_target_destroy_notify);
GeeEqualDataFunc gee_concurrent_list_get_equal_func (GeeConcurrentList* self,
                                                     gpointer* result_target);
...
GeeConcurrentSet* gee_concurrent_set_new (GType g_type,
                                          GBoxedCopyFunc g_dup_func,
                                          GDestroyNotify g_destroy_func,
                                          GCompareDataFunc compare_func,
                                          gpointer compare_func_target,
                                          GDestroyNotify compare_func_target_destroy_notify);
GeeConcurrentSet* gee_concurrent_set_construct (GType object_type,
                                                GType g_type,
                                                GBoxedCopyFunc g_dup_func,
                                                GDestroyNotify g_destroy_func,
                                                GCompareDataFunc compare_func,
                                                gpointer compare_func_target,
                                                GDestroyNotify compare_func_target_destroy_notify);
gboolean gee_deque_offer_head (GeeDeque* self,
                               gconstpointer element);
...
gint gee_deque_drain_tail (GeeDeque* self,
                           GeeCollection* recipient,
                           gint amount);
...
gconstpointer gee_future_wait (GeeFuture* self,
                               GError** error);
gboolean gee_future_wait_until (GeeFuture* self,
                                gint64 end_time,
                                gconstpointer* value,
                                GError** error);
...
gconstpointer gee_future_wait_finish (GeeFuture* self,
                                      GAsyncResult* _res_,
                                      GError** error);
GeeFuture* gee_future_map (GeeFuture* self,
                           GType a_type,
                           GBoxedCopyFunc a_dup_func,
                           GDestroyNotify a_destroy_func,
...
GeeFuture* gee_future_light_map_fixed (GeeFuture* self,
                                       GType a_type,
                                       GBoxedCopyFunc a_dup_func,
                                       GDestroyNotify a_destroy_func,
                                       ...
                                       gpointer func_target,
                                       GDestroyNotify func_target_destroy_notify);
GeeFuture* gee_future_light_map (GeeFuture* self,
                                 GType a_type,
                                 GBoxedCopyFunc a_dup_func,
                                 GDestroyNotify a_destroy_func,
                                 GeeFutureLightMapFunc func,
                                 gpointer func_target);
GeeFuture* gee_future_zip (GeeFuture* self,
                           GType a_type,
                           GBoxedCopyFunc a_dup_func,
                           GDestroyNotify a_destroy_func,
                           GType b_type,
                           ...
                           GeeFuture* second);
GeeFuture* gee_future_flat_map (GeeFuture* self,
                                GType a_type,
                                GBoxedCopyFunc a_dup_func,
                                GDestroyNotify a_destroy_func,
...
GeeHashMap* gee_hash_map_new (GType k_type,
                              GBoxedCopyFunc k_dup_func,
                              GDestroyNotify k_destroy_func,
                              GType v_type,
                              GBoxedCopyFunc v_dup_func,
...
GeeHashMap* gee_hash_map_construct (GType object_type,
                                    GType k_type,
                                    GBoxedCopyFunc k_dup_func,
                                    GDestroyNotify k_destroy_func,
                                    GType v_type,
                                    ...
                                    gpointer value_equal_func_target,
                                    GDestroyNotify value_equal_func_target_destroy_notify);
GeeHashDataFunc gee_hash_map_get_key_hash_func (GeeHashMap* self,
                                                gpointer* result_target);
GeeEqualDataFunc gee_hash_map_get_key_equal_func (GeeHashMap* self,
                                                  gpointer* result_target);
GeeEqualDataFunc gee_hash_map_get_value_equal_func (GeeHashMap* self,
                                                    gpointer* result_target);
GType gee_hash_multi_map_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (GeeHashMultiMap, g_object_unref)
GeeHashMultiMap* gee_hash_multi_map_new (GType k_type,
                                         GBoxedCopyFunc k_dup_func,
                                         GDestroyNotify k_destroy_func,
                                         GType v_type,
                                         GBoxedCopyFunc v_dup_func,
                                         ...
                                         gpointer value_equal_func_target,
                                         GDestroyNotify value_equal_func_target_destroy_notify);
GeeHashMultiMap* gee_hash_multi_map_construct (GType object_type,
                                               GType k_type,
                                               GBoxedCopyFunc k_dup_func,
                                               GDestroyNotify k_destroy_func,
                                               GType v_type,
                                               ...
                                               gpointer value_equal_func_target,
                                               GDestroyNotify value_equal_func_target_destroy_notify);
GeeHashDataFunc gee_hash_multi_map_get_key_hash_func (GeeHashMultiMap* self,
                                                      gpointer* result_target);
GeeEqualDataFunc gee_hash_multi_map_get_key_equal_func (GeeHashMultiMap* self,
                                                        gpointer* result_target);
GeeHashDataFunc gee_hash_multi_map_get_value_hash_func (GeeHashMultiMap* self,
                                                        gpointer* result_target);
GeeEqualDataFunc gee_hash_multi_map_get_value_equal_func (GeeHashMultiMap* self,
                                                          gpointer* result_target);
GType gee_hash_multi_set_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (GeeHashMultiSet, g_object_unref)
GeeHashMultiSet* gee_hash_multi_set_new_fixed (GType g_type,
                                               GBoxedCopyFunc g_dup_func,
                                               GDestroyNotify g_destroy_func,
                                               ...
                                               gpointer equal_func_target,
                                               GDestroyNotify equal_func_target_destroy_notify);
GeeHashMultiSet* gee_hash_multi_set_construct (GType object_type,
                                               GType g_type,
                                               GBoxedCopyFunc g_dup_func,
                                               GDestroyNotify g_destroy_func,
                                               GeeHashDataFunc hash_func,
                                               ...
                                               gpointer equal_func_target,
                                               GDestroyNotify equal_func_target_destroy_notify);
GeeHashMultiSet* gee_hash_multi_set_new (GType g_type,
                                         GBoxedCopyFunc g_dup_func,
                                         GDestroyNotify g_destroy_func,
                                         GeeHashDataFunc hash_func,
                                         gpointer hash_func_target,
...
GeeHashMultiSet* gee_hash_multi_set_construct_broken (GType object_type,
                                                      GType g_type,
                                                      GBoxedCopyFunc g_dup_func,
                                                      GDestroyNotify g_destroy_func,
                                                      GeeHashDataFunc hash_func,
                                                      ...
                                                      GeeEqualDataFunc equal_func,
                                                      gpointer equal_func_target) G_GNUC_DEPRECATED ;
GeeHashDataFunc gee_hash_multi_set_get_hash_func (GeeHashMultiSet* self,
                                                  gpointer* result_target);
GeeEqualDataFunc gee_hash_multi_set_get_equal_func (GeeHashMultiSet* self,
                                                    gpointer* result_target);
GType gee_hash_set_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (GeeHashSet, g_object_unref)
GeeHashSet* gee_hash_set_new (GType g_type,
                              GBoxedCopyFunc g_dup_func,
                              GDestroyNotify g_destroy_func,
                              GeeHashDataFunc hash_func,
                              gpointer hash_func_target,
                              ...
                              gpointer equal_func_target,
                              GDestroyNotify equal_func_target_destroy_notify);
GeeHashSet* gee_hash_set_construct (GType object_type,
                                    GType g_type,
                                    GBoxedCopyFunc g_dup_func,
                                    GDestroyNotify g_destroy_func,
                                    GeeHashDataFunc hash_func,
                                    ...
                                    gpointer equal_func_target,
                                    GDestroyNotify equal_func_target_destroy_notify);
GeeHashDataFunc gee_hash_set_get_hash_func (GeeHashSet* self,
                                            gpointer* result_target);
GeeEqualDataFunc gee_hash_set_get_equal_func (GeeHashSet* self,
                                              gpointer* result_target);
...
GeeHazardPointer* gee_hazard_pointer_get_hazard_pointer (GType g_type,
                                                         GBoxedCopyFunc g_dup_func,
                                                         GDestroyNotify g_destroy_func,
                                                         gconstpointer** aptr,
                                                         gsize mask,
                                                         gsize* mask_out);
gpointer gee_hazard_pointer_get_pointer (GType g_type,
                                         GBoxedCopyFunc g_dup_func,
                                         GDestroyNotify g_destroy_func,
                                         gconstpointer** aptr,
                                         gsize mask,
                                         gsize* mask_out);
GeeHazardPointer* gee_hazard_pointer_exchange_hazard_pointer (GType g_type,
                                                              GBoxedCopyFunc g_dup_func,
                                                              GDestroyNotify g_destroy_func,
                                                              gconstpointer** aptr,
                                                              gpointer new_ptr,
                                                              ...
                                                              gsize new_mask,
                                                              gsize* old_mask);
void gee_hazard_pointer_set_pointer (GType g_type,
                                     GBoxedCopyFunc g_dup_func,
                                     GDestroyNotify g_destroy_func,
                                     gconstpointer** aptr,
                                     gpointer new_ptr,
                                     gsize mask,
                                     gsize new_mask);
gpointer gee_hazard_pointer_exchange_pointer (GType g_type,
                                              GBoxedCopyFunc g_dup_func,
                                              GDestroyNotify g_destroy_func,
                                              gconstpointer** aptr,
                                              gpointer new_ptr,
                                              ...
                                              gsize new_mask,
                                              gsize* old_mask);
gboolean gee_hazard_pointer_compare_and_exchange_pointer (GType g_type,
                                                          GBoxedCopyFunc g_dup_func,
                                                          GDestroyNotify g_destroy_func,
                                                          gconstpointer** aptr,
                                                          ...
                                                          gsize old_mask,
                                                          gsize new_mask);
gconstpointer gee_hazard_pointer_get (GeeHazardPointer* self,
                                      gboolean other_thread);
void gee_hazard_pointer_release (GeeHazardPointer* self,
...
GeeIterator* gee_iterator_unfold (GType a_type,
                                  GBoxedCopyFunc a_dup_func,
                                  GDestroyNotify a_destroy_func,
                                  GeeUnfoldFunc f,
                                  gpointer f_target,
                                  GDestroyNotify f_target_destroy_notify,
                                  GeeLazy* current);
GeeIterator* gee_iterator_concat (GType g_type,
                                  GBoxedCopyFunc g_dup_func,
                                  GDestroyNotify g_destroy_func,
                                  GeeIterator* iters);
gboolean gee_iterator_get_valid (GeeIterator* self);
gboolean gee_iterator_get_read_only (GeeIterator* self);
GeeLazy* gee_lazy_new (GType g_type,
                       GBoxedCopyFunc g_dup_func,
                       GDestroyNotify g_destroy_func,
                       GeeLazyFunc func,
                       gpointer func_target,
                       GDestroyNotify func_target_destroy_notify);
GeeLazy* gee_lazy_construct (GType object_type,
                             GType g_type,
                             GBoxedCopyFunc g_dup_func,
                             GDestroyNotify g_destroy_func,
                             GeeLazyFunc func,
                             gpointer func_target,
                             GDestroyNotify func_target_destroy_notify);
GeeLazy* gee_lazy_new_from_value (GType g_type,
                                  GBoxedCopyFunc g_dup_func,
                                  GDestroyNotify g_destroy_func,
                                  gconstpointer item);
GeeLazy* gee_lazy_construct_from_value (GType object_type,
                                        GType g_type,
                                        GBoxedCopyFunc g_dup_func,
                                        GDestroyNotify g_destroy_func,
                                        gconstpointer item);
...
gpointer gee_list_get (GeeList* self,
                       gint index);
void gee_list_set (GeeList* self,
                   gint index,
                   gconstpointer item);
gint gee_list_index_of (GeeList* self,
                        gconstpointer item);
void gee_list_insert (GeeList* self,
                      gint index,
                      gconstpointer item);
gpointer gee_list_remove_at (GeeList* self,
                             gint index);
GeeList* gee_list_slice (GeeList* self,
                         gint start,
                         gint stop);
gpointer gee_list_first (GeeList* self);
gpointer gee_list_last (GeeList* self);
void gee_list_insert_all (GeeList* self,
                          gint index,
                          GeeCollection* collection);
void gee_list_sort (GeeList* self,
                    GCompareDataFunc compare_func,
                    gpointer compare_func_target,
                    GDestroyNotify compare_func_target_destroy_notify);
GeeList* gee_list_empty (GType g_type,
                         GBoxedCopyFunc g_dup_func,
                         GDestroyNotify g_destroy_func);
GeeList* gee_list_get_read_only_view (GeeList* self);
void gee_list_iterator_set (GeeListIterator* self,
                            gconstpointer item);
void gee_list_iterator_add (GeeListIterator* self,
                            gconstpointer item);
gint gee_list_iterator_index (GeeListIterator* self);
gboolean gee_map_has_key (GeeMap* self,
                          gconstpointer key);
gboolean gee_map_contains (GeeMap* self,
                           gconstpointer key) G_GNUC_DEPRECATED ;
gboolean gee_map_has (GeeMap* self,
                      gconstpointer key,
                      gconstpointer value);
gpointer gee_map_get (GeeMap* self,
                      gconstpointer key);
void gee_map_set (GeeMap* self,
                  gconstpointer key,
                  gconstpointer value);
gboolean gee_map_unset (GeeMap* self,
                        gconstpointer key,
                        gpointer* value);
gboolean gee_map_remove (GeeMap* self,
                         gconstpointer key,
                         gpointer* value) G_GNUC_DEPRECATED ;
void gee_map_clear (GeeMap* self);
GeeMapIterator* gee_map_map_iterator (GeeMap* self);
void gee_map_set_all (GeeMap* self,
                      GeeMap* map);
gboolean gee_map_unset_all (GeeMap* self,
                            GeeMap* map);
gboolean gee_map_remove_all (GeeMap* self,
                             GeeMap* map) G_GNUC_DEPRECATED ;
gboolean gee_map_has_all (GeeMap* self,
                          GeeMap* map);
gboolean gee_map_contains_all (GeeMap* self,
                               GeeMap* map) G_GNUC_DEPRECATED ;
GeeMap* gee_map_empty (GType k_type,
                       GBoxedCopyFunc k_dup_func,
                       GDestroyNotify k_destroy_func,
                       GType v_type,
                       GBoxedCopyFunc v_dup_func,
...
GeeMapEntry* gee_map_entry_construct (GType object_type,
                                      GType k_type,
                                      GBoxedCopyFunc k_dup_func,
                                      GDestroyNotify k_destroy_func,
                                      GType v_type,
...
void gee_map_entry_set_value (GeeMapEntry* self,
                              gconstpointer value);
...
void gee_map_iterator_set_value (GeeMapIterator* self,
                                 gconstpointer value);
void gee_map_iterator_unset (GeeMapIterator* self);
gpointer gee_map_iterator_fold (GeeMapIterator* self,
                                GType a_type,
                                GBoxedCopyFunc a_dup_func,
                                GDestroyNotify a_destroy_func,
                                GeeFoldMapFunc f,
                                gpointer f_target,
                                gpointer seed);
gboolean gee_map_iterator_foreach (GeeMapIterator* self,
                                   GeeForallMapFunc f,
                                   gpointer f_target);
...
gboolean gee_multi_map_contains (GeeMultiMap* self,
                                 gconstpointer key);
GeeCollection* gee_multi_map_get (GeeMultiMap* self,
                                  gconstpointer key);
void gee_multi_map_set (GeeMultiMap* self,
                        gconstpointer key,
                        gconstpointer value);
gboolean gee_multi_map_remove (GeeMultiMap* self,
                               gconstpointer key,
                               gconstpointer value);
gboolean gee_multi_map_remove_all (GeeMultiMap* self,
                                   gconstpointer key);
...
gint gee_multi_set_count (GeeMultiSet* self,
                          gconstpointer item);
GeeSet* gee_multi_set_empty (GType g_type,
                             GBoxedCopyFunc g_dup_func,
                             GDestroyNotify g_destroy_func);
...
gboolean gee_queue_offer (GeeQueue* self,
                          gconstpointer element);
...
GeeSet* gee_set_empty (GType g_type,
                       GBoxedCopyFunc g_dup_func,
                       GDestroyNotify g_destroy_func);
GeeSet* gee_set_get_read_only_view (GeeSet* self);
GeeSortedMap* gee_sorted_map_head_map (GeeSortedMap* self,
                                       gconstpointer before);
GeeSortedMap* gee_sorted_map_tail_map (GeeSortedMap* self,
                                       gconstpointer after);
GeeSortedMap* gee_sorted_map_sub_map (GeeSortedMap* self,
                                      gconstpointer before,
                                      gconstpointer after);
GeeMap* gee_sorted_map_empty (GType k_type,
                              GBoxedCopyFunc k_dup_func,
                              GDestroyNotify k_destroy_func,
                              GType v_type,
                              GBoxedCopyFunc v_dup_func,
...
GeeIterator* gee_sorted_set_iterator_at (GeeSortedSet* self,
                                         gconstpointer element);
gpointer gee_sorted_set_lower (GeeSortedSet* self,
                               gconstpointer element);
gpointer gee_sorted_set_higher (GeeSortedSet* self,
                                gconstpointer element);
gpointer gee_sorted_set_floor (GeeSortedSet* self,
                               gconstpointer element);
gpointer gee_sorted_set_ceil (GeeSortedSet* self,
                              gconstpointer element);
GeeSortedSet* gee_sorted_set_head_set (GeeSortedSet* self,
                                       gconstpointer before);
GeeSortedSet* gee_sorted_set_tail_set (GeeSortedSet* self,
                                       gconstpointer after);
GeeSortedSet* gee_sorted_set_sub_set (GeeSortedSet* self,
                                      gconstpointer from,
                                      gconstpointer to);
GeeSortedSet* gee_sorted_set_empty (GType g_type,
                                    GBoxedCopyFunc g_dup_func,
                                    GDestroyNotify g_destroy_func);
...
void gee_async_task_finish (GAsyncResult* _res_,
                            GError** error);
gboolean gee_traversable_foreach (GeeTraversable* self,
                                  GeeForallFunc f,
                                  gpointer f_target);
GeeIterator* gee_traversable_stream (GeeTraversable* self,
                                     GType a_type,
                                     GBoxedCopyFunc a_dup_func,
                                     GDestroyNotify a_destroy_func,
                                     GeeStreamFunc f,
                                     gpointer f_target,
                                     GDestroyNotify f_target_destroy_notify);
gpointer gee_traversable_fold (GeeTraversable* self,
                               GType a_type,
                               GBoxedCopyFunc a_dup_func,
                               GDestroyNotify a_destroy_func,
                               GeeFoldFunc f,
                               gpointer f_target,
                               gpointer seed);
GeeIterator* gee_traversable_map (GeeTraversable* self,
                                  GType a_type,
                                  GBoxedCopyFunc a_dup_func,
                                  GDestroyNotify a_destroy_func,
                                  GeeMapFunc f,
                                  gpointer f_target);
GeeIterator* gee_traversable_scan (GeeTraversable* self,
                                   GType a_type,
                                   GBoxedCopyFunc a_dup_func,
                                   GDestroyNotify a_destroy_func,
                                   GeeFoldFunc f,
                                   gpointer f_target,
                                   gpointer seed);
GeeIterator* gee_traversable_filter (GeeTraversable* self,
                                     GeePredicate pred,
                                     gpointer pred_target,
                                     GDestroyNotify pred_target_destroy_notify);
GeeIterator* gee_traversable_chop (GeeTraversable* self,
                                   gint offset,
                                   gint length);
GeeIterator* gee_traversable_flat_map (GeeTraversable* self,
                                       GType a_type,
                                       GBoxedCopyFunc a_dup_func,
                                       GDestroyNotify a_destroy_func,
                                       GeeFlatMapFunc f,
                                       gpointer f_target,
                                       GDestroyNotify f_target_destroy_notify);
GeeIterator** gee_traversable_tee (GeeTraversable* self,
                                   guint forks,
                                   gint* result_length1);
gpointer gee_traversable_first_match (GeeTraversable* self,
                                      GeePredicate pred,
                                      gpointer pred_target,
                                      GDestroyNotify pred_target_destroy_notify);
gboolean gee_traversable_any_match (GeeTraversable* self,
                                    GeePredicate pred,
                                    gpointer pred_target,
                                    GDestroyNotify pred_target_destroy_notify);
gboolean gee_traversable_all_match (GeeTraversable* self,
                                    GeePredicate pred,
                                    gpointer pred_target,
                                    GDestroyNotify pred_target_destroy_notify);
gpointer gee_traversable_max (GeeTraversable* self,
                              GCompareDataFunc compare,
                              gpointer compare_target,
                              GDestroyNotify compare_target_destroy_notify);
gpointer gee_traversable_min (GeeTraversable* self,
                              GCompareDataFunc compare,
                              gpointer compare_target,
                              GDestroyNotify compare_target_destroy_notify);
GeeIterator* gee_traversable_order_by (GeeTraversable* self,
                                       GCompareDataFunc compare,
                                       gpointer compare_target,
                                       GDestroyNotify compare_target_destroy_notify);
...
GeeTreeMap* gee_tree_map_new (GType k_type,
                              GBoxedCopyFunc k_dup_func,
                              GDestroyNotify k_destroy_func,
                              GType v_type,
                              GBoxedCopyFunc v_dup_func,
                              ...
                              gpointer value_equal_func_target,
                              GDestroyNotify value_equal_func_target_destroy_notify);
GeeTreeMap* gee_tree_map_construct (GType object_type,
                                    GType k_type,
                                    GBoxedCopyFunc k_dup_func,
                                    GDestroyNotify k_destroy_func,
                                    GType v_type,
                                    ...
                                    gpointer value_equal_func_target,
                                    GDestroyNotify value_equal_func_target_destroy_notify);
GCompareDataFunc gee_tree_map_get_key_compare_func (GeeTreeMap* self,
                                                    gpointer* result_target);
GeeEqualDataFunc gee_tree_map_get_value_equal_func (GeeTreeMap* self,
                                                    gpointer* result_target);
GType gee_tree_multi_map_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (GeeTreeMultiMap, g_object_unref)
GeeTreeMultiMap* gee_tree_multi_map_new (GType k_type,
                                         GBoxedCopyFunc k_dup_func,
                                         GDestroyNotify k_destroy_func,
                                         GType v_type,
                                         GBoxedCopyFunc v_dup_func,
...
GeeTreeMultiMap* gee_tree_multi_map_construct (GType object_type,
                                               GType k_type,
                                               GBoxedCopyFunc k_dup_func,
                                               GDestroyNotify k_destroy_func,
                                               GType v_type,
                                               ...
                                               gpointer value_compare_func_target,
                                               GDestroyNotify value_compare_func_target_destroy_notify);
GCompareDataFunc gee_tree_multi_map_get_key_compare_func (GeeTreeMultiMap* self,
                                                          gpointer* result_target);
GCompareDataFunc gee_tree_multi_map_get_value_compare_func (GeeTreeMultiMap* self,
                                                            gpointer* result_target);
GType gee_tree_multi_set_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (GeeTreeMultiSet, g_object_unref)
GeeTreeMultiSet* gee_tree_multi_set_new (GType g_type,
                                         GBoxedCopyFunc g_dup_func,
                                         GDestroyNotify g_destroy_func,
                                         GCompareDataFunc compare_func,
                                         gpointer compare_func_target,
                                         GDestroyNotify compare_func_target_destroy_notify);
GeeTreeMultiSet* gee_tree_multi_set_construct (GType object_type,
                                               GType g_type,
                                               GBoxedCopyFunc g_dup_func,
                                               GDestroyNotify g_destroy_func,
                                               GCompareDataFunc compare_func,
                                               gpointer compare_func_target,
                                               GDestroyNotify compare_func_target_destroy_notify);
GCompareDataFunc gee_tree_multi_set_get_compare_func (GeeTreeMultiSet* self,
                                                      gpointer* result_target);
GType gee_tree_set_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (GeeTreeSet, g_object_unref)
GeeTreeSet* gee_tree_set_new (GType g_type,
                              GBoxedCopyFunc g_dup_func,
                              GDestroyNotify g_destroy_func,
                              GCompareDataFunc compare_func,
                              gpointer compare_func_target,
                              GDestroyNotify compare_func_target_destroy_notify);
GeeTreeSet* gee_tree_set_construct (GType object_type,
                                    GType g_type,
                                    GBoxedCopyFunc g_dup_func,
                                    GDestroyNotify g_destroy_func,
                                    GCompareDataFunc compare_func,
                                    gpointer compare_func_target,
                                    GDestroyNotify compare_func_target_destroy_notify);
GCompareDataFunc gee_tree_set_get_compare_func (GeeTreeSet* self,
                                                gpointer* result_target);
...
GeeUnrolledLinkedList* gee_unrolled_linked_list_new (GType g_type,
                                                     GBoxedCopyFunc g_dup_func,
                                                     GDestroyNotify g_destroy_func,
                                                     GeeEqualDataFunc equal_func,
                                                     gpointer equal_func_target,
                                                     GDestroyNotify equal_func_target_destroy_notify);
GeeUnrolledLinkedList* gee_unrolled_linked_list_construct (GType object_type,
                                                           GType g_type,
                                                           GBoxedCopyFunc g_dup_func,
                                                           GDestroyNotify g_destroy_func,
                                                           GeeEqualDataFunc equal_func,
                                                           gpointer equal_func_target,
                                                           GDestroyNotify equal_func_target_destroy_notify);
GeeEqualDataFunc gee_unrolled_linked_list_get_equal_func (GeeUnrolledLinkedList* self,
                                                          gpointer* result_target);
