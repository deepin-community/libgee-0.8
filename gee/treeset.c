/* treeset.c generated by valac 0.52.0, the Vala compiler
                           ...
                           GeeTreeSetNode* * root)
{
	...
	_tmp6_ = *root;
	*root = NULL;
	_gee_tree_set_node_free0 (_tmp5_->right);
	_tmp5_->right = _tmp6_;
	_tmp7_ = pivot;
	pivot = NULL;
                          ...
                          GeeTreeSetNode* * root)
{
	...
	_tmp6_ = *root;
	*root = NULL;
	_gee_tree_set_node_free0 (_tmp5_->left);
	_tmp5_->left = _tmp6_;
	_tmp7_ = pivot;
	pivot = NULL;
	_gee_tree_set_node_free0 (*root);
                     ...
                     GeeTreeSetNode* n)
{
	...
	if (n != NULL) {
		...
		_tmp1_ = n->color;
		_tmp0_ = _tmp1_ == GEE_TREE_SET_NODE_COLOR_RED;
	} else {
		_tmp0_ = FALSE;
	}
	result = _tmp0_;
                       ...
                       GeeTreeSetNode* n)
{
	...
	if (n == NULL) {
		...
		GeeTreeSetNodeColor _tmp1_;
		_tmp1_ = n->color;
		_tmp0_ = _tmp1_ == GEE_TREE_SET_NODE_COLOR_BLACK;
	}
	result = _tmp0_;
	return result;
}
...
gee_tree_set_node_flip (GeeTreeSetNode* self)
{
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = self->color;
	self->color = gee_tree_set_node_color_flip (_tmp0_);
	_tmp1_ = self->left;
	if (_tmp1_ != NULL) {
		GeeTreeSetNode* _tmp2_;
		GeeTreeSetNode* _tmp3_;
		...
		_tmp3_ = self->left;
		_tmp4_ = _tmp3_->color;
		_tmp2_->color = gee_tree_set_node_color_flip (_tmp4_);
	}
	_tmp5_ = self->right;
	if (_tmp5_ != NULL) {
		GeeTreeSetNode* _tmp6_;
		GeeTreeSetNode* _tmp7_;
		GeeTreeSetNodeColor _tmp8_;
		_tmp6_ = self->right;
		_tmp7_ = self->right;
		_tmp8_ = _tmp7_->color;
		_tmp6_->color = gee_tree_set_node_color_flip (_tmp8_);
	}
}
                             ...
                             gconstpointer after)
{
	...
	switch (_tmp0_) {
		case GEE_TREE_SET_RANGE_TYPE_HEAD:
		{
			...
			_tmp3_ = gee_tree_set_range_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, _tmp1_, after, _tmp2_);
			result = _tmp3_;
			return result;
		}
		case GEE_TREE_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp7_ = gee_tree_set_max (_tmp5_, after, _tmp6_);
			_tmp8_ = _tmp7_;
			_tmp9_ = gee_tree_set_range_new_tail (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, _tmp4_, _tmp8_);
			_tmp10_ = _tmp9_;
		...
		case GEE_TREE_SET_RANGE_TYPE_EMPTY:
		{
			...
			_tmp11_ = _gee_tree_set_range_ref0 (self);
			result = _tmp11_;
			return result;
		}
		case GEE_TREE_SET_RANGE_TYPE_BOUNDED:
		{
			...
			gconstpointer _tmp17_;
			GeeTreeSetRange* _tmp18_;
			_tmp12_ = self->priv->set;
			_tmp13_ = self->priv->after;
			_tmp14_ = gee_tree_set_max (_tmp12_, after, _tmp13_);
			_after = _tmp14_;
			_tmp15_ = self->priv->set;
			_tmp16_ = _after;
			_tmp17_ = self->priv->before;
			_tmp18_ = gee_tree_set_range_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, _tmp15_, _tmp16_, _tmp17_);
			result = _tmp18_;
                             ...
                             gconstpointer before)
{
	...
	switch (_tmp0_) {
		case GEE_TREE_SET_RANGE_TYPE_HEAD:
		{
			...
			_tmp5_ = _tmp4_;
			_tmp6_ = gee_tree_set_range_new_head (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, _tmp1_, _tmp5_);
			_tmp7_ = _tmp6_;
		...
		case GEE_TREE_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp10_ = gee_tree_set_range_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, _tmp8_, _tmp9_, before);
			result = _tmp10_;
			return result;
		}
		case GEE_TREE_SET_RANGE_TYPE_EMPTY:
		...
		case GEE_TREE_SET_RANGE_TYPE_BOUNDED:
		{
			...
			_tmp14_ = gee_tree_set_min (_tmp12_, before, _tmp13_);
			_before = _tmp14_;
			_tmp15_ = self->priv->set;
                        ...
                        gconstpointer before)
{
	...
	GeeTreeSetRangeType _tmp10_;
	gpointer _after = NULL;
	gpointer _tmp15_;
	GeeTreeSet* _tmp16_;
	gconstpointer _tmp17_;
	gconstpointer _tmp18_;
	GeeTreeSetRange* _tmp19_;
	GeeTreeSetRange* result = NULL;
	g_return_val_if_fail (self != NULL, NULL);
	_tmp0_ = self->priv->type;
	...
	if (_tmp3_ != GEE_TREE_SET_RANGE_TYPE_TAIL) {
		...
		_tmp6_ = gee_tree_set_min (_tmp4_, before, _tmp5_);
		((_tmp2_ == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (_tmp2_ = (self->priv->g_destroy_func (_tmp2_), NULL));
		_tmp2_ = _tmp6_;
	} else {
		gpointer _tmp7_;
		_tmp7_ = ((before != NULL) && (self->priv->g_dup_func != NULL)) ? self->priv->g_dup_func ((gpointer) before) : ((gpointer) before);
		((_tmp2_ == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (_tmp2_ = (self->priv->g_destroy_func (_tmp2_), NULL));
		_tmp2_ = _tmp7_;
	}
	_tmp8_ = ((_tmp2_ != NULL) && (self->priv->g_dup_func != NULL)) ? self->priv->g_dup_func ((gpointer) _tmp2_) : ((gpointer) _tmp2_);
	_before = _tmp8_;
	_tmp10_ = self->priv->type;
	if (_tmp10_ != GEE_TREE_SET_RANGE_TYPE_HEAD) {
		GeeTreeSet* _tmp11_;
		...
		gpointer _tmp14_;
		_tmp14_ = ((after != NULL) && (self->priv->g_dup_func != NULL)) ? self->priv->g_dup_func ((gpointer) after) : ((gpointer) after);
		((_tmp9_ == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (_tmp9_ = (self->priv->g_destroy_func (_tmp9_), NULL));
		_tmp9_ = _tmp14_;
	}
	_tmp15_ = ((_tmp9_ != NULL) && (self->priv->g_dup_func != NULL)) ? self->priv->g_dup_func ((gpointer) _tmp9_) : ((gpointer) _tmp9_);
	_after = _tmp15_;
	_tmp16_ = self->priv->set;
	_tmp17_ = _after;
	_tmp18_ = _before;
	_tmp19_ = gee_tree_set_range_new (self->priv->g_type, (GBoxedCopyFunc) self->priv->g_dup_func, (GDestroyNotify) self->priv->g_destroy_func, _tmp16_, _tmp17_, _tmp18_);
	result = _tmp19_;
	((_after == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (_after = (self->priv->g_destroy_func (_after), NULL));
	((_tmp9_ == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (_tmp9_ = (self->priv->g_destroy_func (_tmp9_), NULL));
	((_before == NULL) || (self->priv->g_destroy_func == NULL)) ? NULL : (_before = (self->priv->g_destroy_func (_before), NULL));
                                  ...
                                  gconstpointer item)
{
	...
	switch (_tmp0_) {
		case GEE_TREE_SET_RANGE_TYPE_HEAD:
		{
			...
			_tmp4__target = _tmp3__target;
			_tmp5_ = self->priv->before;
			if (_tmp4_ (item, _tmp5_, _tmp4__target) < 0) {
				_tmp1_ = 0;
			} else {
				_tmp1_ = 1;
			}
		...
		case GEE_TREE_SET_RANGE_TYPE_TAIL:
		{
			...
			_tmp8_ = gee_tree_set_get_compare_func (_tmp7_, &_tmp8__target);
			_tmp9_ = _tmp8_;
			_tmp9__target = _tmp8__target;
			_tmp10_ = self->priv->after;
			if (_tmp9_ (item, _tmp10_, _tmp9__target) >= 0) {
				_tmp6_ = 0;
			} else {
				_tmp6_ = -1;
			}
		...
		case GEE_TREE_SET_RANGE_TYPE_BOUNDED:
		{
			...
			gconstpointer _tmp15_;
			_tmp12_ = self->priv->set;
			_tmp13_ = gee_tree_set_get_compare_func (_tmp12_, &_tmp13__target);
			_tmp14_ = _tmp13_;
			_tmp14__target = _tmp13__target;
			_tmp15_ = self->priv->after;
			if (_tmp14_ (item, _tmp15_, _tmp14__target) >= 0) {
				gint _tmp16_ = 0;
				GeeTreeSet* _tmp17_;
				...
				_tmp17_ = self->priv->set;
				_tmp18_ = gee_tree_set_get_compare_func (_tmp17_, &_tmp18__target);
				_tmp19_ = _tmp18_;
				_tmp19__target = _tmp18__target;
				_tmp20_ = self->priv->before;
				if (_tmp19_ (item, _tmp20_, _tmp19__target) < 0) {
					_tmp16_ = 0;
				} else {
					_tmp16_ = 1;
				}
	...
	switch (_tmp0_) {
		case GEE_TREE_SET_RANGE_TYPE_HEAD:
		{
			...
			if (_tmp3_ == NULL) {
				...
				_tmp5_ = _tmp4_->priv->_first;
				_tmp6_ = _tmp5_->key;
				_tmp1_ = !gee_tree_set_range_in_range (self, _tmp6_);
			}
			result = _tmp1_;
			return result;
		}
		case GEE_TREE_SET_RANGE_TYPE_TAIL:
		{
			...
			if (_tmp9_ == NULL) {
				...
				_tmp12_ = _tmp11_->key;
				_tmp7_ = !gee_tree_set_range_in_range (self, _tmp12_);
			}
			result = _tmp7_;
			return result;
		}
		...
		{
			GeeTreeSetNode* _tmp13_;
			_tmp13_ = gee_tree_set_range_first (self);
			result = _tmp13_ == NULL;
			return result;
		}
		default:
