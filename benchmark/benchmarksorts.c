/* benchmarksorts.c generated by valac 0.52.0, the Vala compiler
...
GeeBenchmarkTimSort* gee_benchmark_tim_sort_new (GType g_type,
                                                 GBoxedCopyFunc g_dup_func,
                                                 GDestroyNotify g_destroy_func);
GeeBenchmarkTimSort* gee_benchmark_tim_sort_construct (GType object_type,
                                                       GType g_type,
                                                       GBoxedCopyFunc g_dup_func,
                                                       GDestroyNotify g_destroy_func);
...
static void gee_benchmark_merge_sort_real_process_collection (GeeBenchmarkAlgorithm* base,
 ...
 G_GNUC_INTERNAL void gee_merge_sort_sort (GType g_type,
                          ...
                          GCompareDataFunc compare,
                          gpointer compare_target);
GeeBenchmarkMergeSort* gee_benchmark_merge_sort_new (GType g_type,
                                                     GBoxedCopyFunc g_dup_func,
                                                     GDestroyNotify g_destroy_func);
GeeBenchmarkMergeSort* gee_benchmark_merge_sort_construct (GType object_type,
                                                           GType g_type,
                                                           GBoxedCopyFunc g_dup_func,
                                                           GDestroyNotify g_destroy_func);
